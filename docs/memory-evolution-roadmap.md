...
- persona-memory cluster repair now also reacts to explicit correction phrasing on overlapping persona statements: a corrected older cluster keeps its history but receives a bounded salience penalty until later reaffirmation updates it again
