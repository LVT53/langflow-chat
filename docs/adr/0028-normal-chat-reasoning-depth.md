...
- Extended and maximum profiles should always add real deliberation work once selected; the preserved baseline is one pass for Extended and two for Max, while dynamic high-cost plans may choose a bounded alternative pass sequence when depth signals justify it.
