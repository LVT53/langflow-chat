...
const dictionary = {
	en: {
		...
		"admin.campaigns.description":
			"Author first-run and release campaign modals with localized copy, screenshots, publishing checks, and exact user-facing previews.",
	...
	hu: {
		...
		"fork.editWarning":
			"Az üzenet szerkesztése lecseréli azt a forráselőzményt, amelyből már készült elágazás. A meglévő elágazások változatlanok maradnak. Folytatod?",
		"fork.regenerateWarning":
			"A válasz újragenerálása lecseréli azt a forráselőzményt, amelyből már készült elágazás. A meglévő elágazások változatlanok maradnak. Folytatod?",
