...
const dictionary = {
	en: {
		...
		"fileProduction.failed": "Needs attention",
	...
	hu: {
		...
		"login.pleaseFillAllFields": "Add meg az email címet és a jelszót.",
		...
		"codeBlock.expand": "Kodblokk kibontasa",
		"codeBlock.collapse": "Kodblokk osszecsukasa",
		"codeBlock.copyCode": "Kod masolasa",
		"composerTools.menu": "Szerkeszto eszkozok",
		"composerTools.model": "Modell",
		"composerTools.style": "Stílus",
		"composerTools.defaultStyle": "AlfyAI",
		"composerTools.defaultStyleLabel": "Alapértelmezett stílus",
		"composerTools.attachFile": "Fajl csatolasa",
		"composerTools.attachFileMaxSize": "Fajl csatolasa (max 100MB)",
		...
		"evidenceManager.close": "Bizonyitek kezelo bezarasa",
		"messageBubble.messageInfo": "Uzenet informacio",
		"messageBubble.regenerate": "Valasz ujrageneralasa",
		"messageBubble.editMessage": "Uzenet szerkesztese",
		"messageBubble.copyMessage": "Uzenet masolasa",
		...
		"fileProduction.failed": "Figyelmet igenyel",
		"fileProduction.cancelled": "Megszakitva",
		"fileProduction.noFiles": "Meg nincs fajl",
		"fileProduction.oneFile": "1 fajl",
		"fileProduction.fileCount": "{count} fajl",
		"fileProduction.queuedDescription": "A fajl keszito varakozik.",
		"fileProduction.runningDescription": "A fajlok a hatterben keszulnek.",
		"fileProduction.failedDescription": "A fajl keszites nem fejezodott be.",
		"fileProduction.cancelledDescription": "Ez a keres meg lett szakitva.",
		"fileProduction.retry": "Ujra",
		...
		"fileProduction.error.page_limit_exceeded": "A dokumentum tullepne az oldal limitet.",
		"fileProduction.error.table_limit_exceeded": "Egy tabla tullepi a beallitott limitet.",
		"fileProduction.error.chart_limit_exceeded": "Egy diagram tullepi a beallitott limitet.",
		"fileProduction.error.image_limit_exceeded": "A kepek tullepik a beallitott limitet.",
		"fileProduction.error.renderer_timeout": "A dokumentum rendereles idotullepes miatt leallt.",
		"fileProduction.error.sandbox_timeout": "A program futasa idotullepes miatt leallt.",
		...
		"fileProduction.error.output_file_too_large": "Egy eloallitott fajl tul nagy.",
		"fileProduction.error.job_outputs_too_large": "Az eloallitott fajlok tul nagyok.",
		...
		"documentWorkspace.documentWorkspace": "Dokumentum munkaterulet",
		"documentWorkspace.resizePanel": "Munkaterulet atmeretezese",
