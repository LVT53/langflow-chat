...
const dictionary = {
	en: {
		...
		"admin.systemSkills.title": "System Skills",
		"admin.systemSkills.description":
			"Manage workspace-wide skills. Users can see enabled, published summaries, but only admins can edit instructions.",
		"admin.systemSkills.new": "New System Skill",
		"admin.systemSkills.loading": "Loading System Skills...",
		"admin.systemSkills.empty": "No System Skills yet.",
		"admin.systemSkills.createTitle": "Create System Skill",
		"admin.systemSkills.editTitle": "Edit System Skill",
		...
		"admin.systemSkills.instructionsPlaceholder": "Admin-only instructions for this System Skill",
		"admin.systemSkills.published": "Published",
		"admin.systemSkills.publish": "Publish",
		"admin.systemSkills.publishA11y": "Publish {name}",
		"admin.systemSkills.save": "Save System Skill",
		"admin.systemSkills.created": "System Skill created.",
		"admin.systemSkills.updated": "System Skill updated.",
		"admin.systemSkills.status.published": "Published",
		"admin.systemSkills.status.draft": "Draft",
		"admin.systemSkills.errors.load": "Failed to load System Skills.",
		"admin.systemSkills.errors.save": "Failed to save System Skill.",
		...
		"pendingSkill.system": "System Skill",
		...
		"skillDrafts.publish": "Publish system skill",
	...
	hu: {
		...
		"admin.systemSkills.title": "Rendszerskillek",
		"admin.systemSkills.description":
			"Munkaterület-szintű skillek kezelése. A felhasználók az engedélyezett, közzétett összefoglalókat látják, de az utasításokat csak adminok szerkeszthetik.",
		"admin.systemSkills.new": "Új rendszerskill",
		"admin.systemSkills.loading": "Rendszerskillek betöltése...",
		"admin.systemSkills.empty": "Még nincsenek rendszerskillek.",
		"admin.systemSkills.createTitle": "Rendszerskill létrehozása",
		"admin.systemSkills.editTitle": "Rendszerskill szerkesztése",
		"admin.systemSkills.displayNamePlaceholder": "Review partner",
		"admin.systemSkills.descriptionPlaceholder": "Felhasználóknak megjelenő rövid cél",
		"admin.systemSkills.instructionsPlaceholder":
			"Csak adminoknak látható utasítások ehhez a rendszerskillhez",
		...
		"admin.systemSkills.save": "Rendszerskill mentése",
		"admin.systemSkills.created": "Rendszerskill létrehozva.",
		"admin.systemSkills.updated": "Rendszerskill frissítve.",
		"admin.systemSkills.status.published": "Közzétéve",
		"admin.systemSkills.status.draft": "Vázlat",
		"admin.systemSkills.errors.load": "Nem sikerült betölteni a rendszerskilleket.",
		"admin.systemSkills.errors.save": "Nem sikerült menteni a rendszerskillt.",
		"composerCommandRegistry.empty":
		...
		"pendingSkill.user": "Skill",
		"pendingSkill.system": "Rendszerskill",
		...
		"skillSessions.finish": "Befejezés",
		...
		"skillDrafts.publish": "Rendszerskill publikálása",
