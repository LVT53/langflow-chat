...
const commonDict = {
	en: {
		...
		"searchModal.noMatches": "No matches found",
		"searchModal.noMatchesHint": "Try a different search term",
		"searchModal.placeholder": "Search conversations...",
	...
	hu: {
		...
		"searchModal.noMatches": "Nincs találat",
		"searchModal.noMatchesHint": "Próbálj más keresési kifejezést",
		"searchModal.placeholder": "Keresés beszélgetések között...",
		"searchModal.recentConversations": "Legutóbbi beszélgetések",
		"searchModal.title": "Keresés",
