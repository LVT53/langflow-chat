...
const commonDict = {
	en: {
		...
		"serverUpdate.description": "The server was updated. Refresh when you're ready to load the latest version.",
		...
		"sidebar.deleteConversationMessage": "Are you sure you want to delete this conversation? This action cannot be undone.",
		"sidebar.deleteConversationTitle": "Delete this conversation?",
		"sidebar.deleteProjectMessage": "The project will be deleted. All chats inside will become unorganized.",
		...
		"sidebar.failedCreateProjectConversation": "Failed to create chat in this project. Please try again.",
		...
		"sidebar.failedReorderSidebar": "Failed to save sidebar order. Please try again.",
		"sidebar.failedUpdateConversationPin": "Failed to update conversation pin. Please try again.",
	...
	hu: {
		...
		"serverUpdate.description": "A szerver frissült. Frissítsd az oldalt, amikor készen állsz a legújabb verzió betöltésére.",
		...
		"sidebar.deleteConversationMessage": "Biztosan törlöd ezt a beszélgetést? Ez a művelet nem vonható vissza.",
		"sidebar.deleteConversationTitle": "Törlöd ezt a beszélgetést?",
		"sidebar.deleteProjectMessage": "A projekt törlődik. A benne lévő beszélgetések rendezetlenek lesznek.",
		...
		"sidebar.failedCreateProjectConversation": "Nem sikerült beszélgetést létrehozni ebben a projektben. Próbáld újra.",
		...
		"sidebar.failedReorderSidebar": "Nem sikerült menteni az oldalsáv sorrendjét. Próbáld újra.",
		"sidebar.failedUpdateConversationPin": "Nem sikerült frissíteni a beszélgetés rögzítését. Próbáld újra.",
		"sidebar.forkIndicatorTooltip": "Elágazás innen: {title}, {sequence}. elágazás",
		"sidebar.groupChatsCreateOne": "Rendezd projektekbe a beszélgetéseidet - kattints a létrehozáshoz",
