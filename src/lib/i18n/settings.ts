...
const settingsDict = {
	en: {
		...
		"admin.campaigns.validation.imageAltRequired": "Localized EN/HU alt text is required when an image is uploaded.",
		"admin.campaigns.validation.localizedContentRequired": "Localized EN/HU title and body are required.",
		...
		"admin.capabilityState.manualOverrideSupported": "Manual override: supported",
		"admin.capabilityState.manualOverrideUnsupported": "Manual override: not supported",
		...
		"admin.composerCommandRegistryDescription": "Expose the Normal Chat command registry shell. Runtime skill behavior stays inactive until later slices are enabled.",
		...
		"admin.contextLimitsDescriptionProvider": "Max Model Context is required for third-party providers.",
		...
		"admin.deepResearchDepthBudgetsDescription": "Edit the normalized focused, standard, and max Deep Research budget policy as JSON.",
		"admin.deepResearchDepthBudgetsJson": "Depth Budget Policy JSON",
		"admin.deepResearchDescription": "Show the Deep Research composer entry and allow research-depth requests in chat.",
		...
		"admin.fillRequiredProviderContext": "Set Max Model Context for this provider.",
		"admin.fillRequiredRateLimitFallback": "Fill in all enabled rate-limit fallback fields.",
		"admin.hide": "Hide",
		"admin.high": "High",
		...
		"admin.invalidRateLimitFallbackTimeout": "Fallback timeout must be a whole number of at least 1000 ms.",
		"admin.joined": "Joined",
		...
		"admin.maxModelContextRequired": "Required for third-party providers. This is the total input plus output context window.",
		...
		"admin.modelIconProviderMissing": "Could not find the provider for this icon upload. Close the form and try again.",
		...
		"admin.rateLimitFallbackDescription": "Retry provider rate-limit responses through a separate OpenAI-compatible endpoint.",
		...
		"admin.systemSkills.description": "Manage admin-defined skills. Users can see enabled, published summaries, but only admins can edit instructions.",
		...
		"admin.thirdPartyDescription": "Third-party models use the same OpenAI-compatible chat runtime and connected tools as built-in models.",
		...
		"admin.webResearchBreadthDescription": "Raise SearXNG result counts and max sources for broader research; lower them to reduce latency.",
		"admin.webResearchContentChars": "Page Content Characters",
		"admin.webResearchDescription": "Server-owned SearXNG search, page opening, source reranking, and citation evidence settings.",
		...
		"admin.webResearchProviderDescription": "SearXNG handles web search through its local JSON API. Brave is still used separately for image search.",
		...
		"settings_deleteUserMessage": "This will permanently delete the selected user account, chats, and stored data. This cannot be undone.",
	...
	hu: {
		...
		"admin.basePromptDescription": "Alapprompt az adott nyelvhez. Hagyd üresen, ha csak a few-shot példákra szeretnél támaszkodni.",
		...
		"admin.campaigns.deleteDraftConfirm": "Törlöd ezt a kampánypiszkozatot? Ez nem vonható vissza.",
		...
		"admin.campaigns.previewNote": "Csak admin előnézet. Nem ír analitikát vagy felhasználói állapotot.",
		...
		"admin.campaigns.validation.imageAltRequired": "Feltöltött kép esetén az angol/magyar képhelyettesítő szöveg kötelező.",
		"admin.campaigns.validation.localizedContentRequired": "Az angol/magyar cím és törzsszöveg kötelező.",
		...
		"admin.capabilityState.manualOverrideSupported": "Kézi felülírás: támogatott",
		"admin.capabilityState.manualOverrideUnsupported": "Kézi felülírás: nem támogatott",
		...
		"admin.codeAppendixDescription": "Opcionális extra sorok, amelyek csak akkor kerülnek hozzáfűzésre, ha a beszélgetés kódolásnak tűnik.",
		...
		"admin.composerCommandRegistryDescription": "Megjeleníti a normál chat parancsregiszterének vázát. A skill futtatási viselkedés a későbbi szeletekig inaktív marad.",
		"admin.composerCommandRegistryEnabled": "Beviteli parancsregiszter engedélyezése",
		"admin.connected": "Kapcsolódva",
		"admin.contextLimits": "Kontextuskorlátok",
		"admin.contextLimitsDescription": "Hagyd üresen a globális alapértelmezések használatához.",
		"admin.contextLimitsDescriptionBuiltIn": "Hagyd üresen a globális alapértelmezések használatához.",
		"admin.contextLimitsDescriptionProvider": "A harmadik féltől származó szolgáltatóknál kötelező a maximális modellkontextus.",
		...
		"admin.createUserDescription": "Új helyi fiók létrehozása, és opcionálisan azonnali adminisztrátori hozzáférés biztosítása.",
		...
		"admin.deepResearchDepthBudgetsDescription": "A fókuszált, normál és max Mély kutatás normalizált keretpolitikája JSON formátumban.",
		"admin.deepResearchDepthBudgetsJson": "Mélységi keretpolitika JSON",
		"admin.deepResearchDescription": "Megjeleníti a Mély kutatás beviteli lehetőséget, és engedélyezi a kutatási mélységet tartalmazó chat kéréseket.",
		...
		"admin.deleteProviderConfirm": "Biztosan törlöd a(z) \"{name}\" szolgáltatót?",
		...
		"admin.fillRequiredBuiltIn": "Töltsd ki a megjelenített nevet, az alap-URL-t és a modell nevét.",
		"admin.fillRequiredFields": "Töltsd ki az összes kötelező szolgáltatói mezőt.",
		"admin.fillRequiredProviderContext": "Állítsd be a szolgáltató maximális modellkontextusát.",
		"admin.fillRequiredRateLimitFallback": "Töltsd ki az összes engedélyezett sebességkorlátos tartalék mezőt.",
		"admin.hide": "Elrejt",
		"admin.high": "Magas",
		...
		"admin.honchoDescription": "Beszélgetések közötti hosszú távú memória Honchón keresztül",
		...
		"admin.honchoPersonaContextWaitMs": "Honcho személyiségkontextusának várakozása (ms)",
		...
		"admin.invalidRateLimitFallbackTimeout": "A tartalék időkorlátnak legalább 1000 ms-os egész számnak kell lennie.",
		...
		"admin.low": "Alacsony",
		"admin.max": "Maximális",
		"admin.maxFileUploadDescription": "Maximális fájlfeltöltési méret bájtban (alapértelmezett 104857600 = 100 MB).",
		...
		"admin.maxModelContextRequired": "Harmadik féltől származó szolgáltatóknál kötelező. Ez a teljes bemeneti és kimeneti kontextusablak.",
		...
		"admin.mineruTimeoutDescription": "Maximális várakozási idő a MinerU válaszára. Nagyobb dokumentumokhoz növeld meg.",
		...
		"admin.model2VisibilityDescription": "A 2. modell elrejtése az alkalmazásból, visszaváltással az 1. modellre",
		"admin.modelCapabilities": "Képességek",
		"admin.modelIconCropTitle": "Modellikon kivágása",
		"admin.modelIconProviderMissing": "Nem található a szolgáltató ehhez az ikonfeltöltéshez. Zárd be az űrlapot, majd próbáld újra.",
		...
		"admin.modelNamePlaceholderProvider": "pl. accounts/fireworks/models/llama-v3-70b",
		...
		"admin.modelTimeoutFailoverEnabled": "Modell időkorlátos tartalék út engedélyezése",
		...
		"admin.nameIdDescription": "Változtathatatlan azonosító a modell kiválasztásához.",
		...
		"admin.rateLimitFallbackDescription": "A szolgáltatói sebességkorlátos válaszok újrapróbálása külön OpenAI-kompatibilis végponton keresztül.",
		"admin.rateLimitFallbackEnabled": "Sebességkorlátos tartalék út engedélyezése",
		...
		"admin.selectUser": "Válassz ki egy felhasználót a fiókadatok és műveletek megtekintéséhez.",
		"admin.show": "Megjelenítés",
		"admin.summarizerModelDescription": "A fenti végpont által kiszolgált modell neve.",
		"admin.summarizerUrlDescription": "OpenAI-kompatibilis végpont. Ugyanazt a vLLM-szervert használja, mint a címgenerátor. Hagyd üresen a letiltáshoz.",
		...
		"admin.systemSkills.instructionsPlaceholder": "Csak adminoknak látható utasítások ehhez a skillhez",
		...
		"admin.webResearchDescription": "Szerveroldali SearXNG keresés, oldalmegnyitás, forrás-újrarangsorolás és idézési bizonyítékok beállításai.",
		...
		"admin.webResearchProviderDescription": "A SearXNG végzi a webes keresést a helyi JSON API-n keresztül. A Brave továbbra is külön, képkereséshez használható.",
