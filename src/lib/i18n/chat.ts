...
const chatDict = {
	en: {
		...
		"atlas.basisMarker": "Basis Marker",
		"atlas.basisMarker.partial": "Partially supported claim",
		"atlas.basisMarker.supported": "Supported claim",
		"atlas.basisMarker.unsupported": "Unsupported claim",
		"atlas.lifecyclePromptPlaceholder": "Describe what Atlas should do next.",
		"atlas.limitations": "Limitations",
		"atlas.limitationsDescription":
			"Atlas notes evidence gaps directly in the report.",
		"atlas.progressLabel": "Atlas progress",
		"atlas.progress.assemble.0": "Shaping the report",
		"atlas.progress.assemble.1": "Arranging the report path",
		"atlas.progress.assemble.2": "Polishing the final structure",
		"atlas.progress.audit.0": "Verifying the evidence",
		"atlas.progress.audit.1": "Checking every claim",
		"atlas.progress.audit.2": "Stress-testing the citations",
		"atlas.progress.coverageReview.0": "Checking evidence coverage",
		"atlas.progress.coverageReview.1": "Looking for bounded evidence gaps",
		"atlas.progress.coverageReview.2":
			"Confirming the report has enough support",
		"atlas.progress.curate.0": "Weighing source quality",
		"atlas.progress.curate.1": "Sorting signal from noise",
		"atlas.progress.curate.2": "Choosing the strongest sources",
		"atlas.progress.decompose.0": "Breaking down the question",
		"atlas.progress.decompose.1": "Sketching the research map",
		"atlas.progress.decompose.2": "Setting the investigation path",
		"atlas.progress.gapFill.0": "Following up on evidence gaps",
		"atlas.progress.gapFill.1": "Checking a bounded evidence target",
		"atlas.progress.gapFill.2": "Adding only useful supporting sources",
		"atlas.progress.integrate.0": "Connecting the strongest threads",
		"atlas.progress.integrate.1": "Threading the findings together",
		"atlas.progress.integrate.2": "Resolving the research patterns",
		"atlas.progress.queued.0": "Waiting for a research slot",
		"atlas.progress.queued.1": "Warming up the source radar",
		"atlas.progress.queued.2": "Preparing the research queue",
		"atlas.progressGapFillFocusLabel": "Atlas evidence follow-up focus",
		"atlas.progressGapFillFocusTitle": "Evidence follow-up",
		"atlas.progressQueriesLabel": "Atlas research questions",
		"atlas.progressQueriesTitle": "Researching",
		"atlas.progress.render.0": "Preparing report files",
		"atlas.progress.render.1": "Packing the report outputs",
		"atlas.progress.render.2": "Finishing downloadable files",
		"atlas.progress.running.1": "Keeping the research trail tidy",
		"atlas.progress.running.2": "Maintaining the research momentum",
		"atlas.progress.search.0": "Following promising leads",
		"atlas.progress.search.1": "Scanning the web horizon",
		"atlas.progress.search.2": "Opening fresh source paths",
		"atlas.reportReady": "Report is ready",
		"atlas.sourceProjection": "Deterministic Sources",
		"atlas.sourceProjectionReady":
			"Sources are generated from accepted evidence.",
		"atlas.progress.synthesize.0": "Distilling the key patterns",
		"atlas.progress.synthesize.1": "Turning notes into insight",
		"atlas.progress.synthesize.2": "Compressing evidence into findings",
	...
	hu: {
		...
		"atlas.basisMarker": "Alátámasztási jelölő",
		"atlas.basisMarker.partial": "Részben alátámasztott állítás",
		"atlas.basisMarker.supported": "Alátámasztott állítás",
		"atlas.basisMarker.unsupported": "Nem alátámasztott állítás",
		"atlas.lifecyclePromptPlaceholder": "Írd le, mit tegyen ezután az Atlas.",
		"atlas.limitations": "Korlátok",
		"atlas.limitationsDescription":
			"Az Atlas a bizonyítékhiányokat közvetlenül a jelentésben jelzi.",
		"atlas.progressLabel": "Atlas előrehaladás",
		"atlas.progress.assemble.0": "A jelentés formálása",
		"atlas.progress.assemble.1": "A jelentés útvonalának rendezése",
		"atlas.progress.assemble.2": "A végső szerkezet csiszolása",
		"atlas.progress.audit.0": "A bizonyítékok ellenőrzése",
		"atlas.progress.audit.1": "Minden állítás ellenőrzése",
		"atlas.progress.audit.2": "Az idézetek próbára tétele",
		"atlas.progress.coverageReview.0": "A bizonyítéklefedettség ellenőrzése",
		"atlas.progress.coverageReview.1": "Korlátozott bizonyítékhiányok keresése",
		"atlas.progress.coverageReview.2":
			"Annak ellenőrzése, hogy elég-e az alátámasztás",
		"atlas.progress.curate.0": "A forrásminőség mérlegelése",
		"atlas.progress.curate.1": "A jel és zaj szétválogatása",
		"atlas.progress.curate.2": "A legerősebb források kiválasztása",
		"atlas.progress.decompose.0": "A kérdés részekre bontása",
		"atlas.progress.decompose.1": "A kutatási térkép felvázolása",
		"atlas.progress.decompose.2": "A vizsgálati út kijelölése",
		"atlas.progress.gapFill.0": "Bizonyítékhiányok célzott követése",
		"atlas.progress.gapFill.1": "Korlátozott bizonyítékcél ellenőrzése",
		"atlas.progress.gapFill.2": "Csak hasznos alátámasztó források hozzáadása",
		"atlas.progress.integrate.0": "A legerősebb szálak összekötése",
		"atlas.progress.integrate.1": "Az eredmények összefűzése",
		"atlas.progress.integrate.2": "A kutatási mintázatok rendezése",
		"atlas.progress.queued.0": "Kutatási helyre vár",
		"atlas.progress.queued.1": "Forrásradar bemelegítése",
		"atlas.progress.queued.2": "A kutatási sor előkészítése",
		"atlas.progressGapFillFocusLabel": "Atlas bizonyítékkövetési fókusz",
		"atlas.progressGapFillFocusTitle": "Bizonyítékkövetés",
		"atlas.progressQueriesLabel": "Atlas kutatási kérdések",
		"atlas.progressQueriesTitle": "Kutatás alatt",
		"atlas.progress.render.0": "Jelentésfájlok előkészítése",
		"atlas.progress.render.1": "A jelentéskimenetek csomagolása",
		"atlas.progress.render.2": "Letölthető fájlok véglegesítése",
		"atlas.progress.running.1": "A kutatási nyomvonal rendezése",
		"atlas.progress.running.2": "A kutatás lendületének fenntartása",
		"atlas.progress.search.0": "Ígéretes nyomok követése",
		"atlas.progress.search.1": "A webes horizont pásztázása",
		"atlas.progress.search.2": "Új forrásutak megnyitása",
		"atlas.reportReady": "A jelentés elkészült",
		"atlas.sourceProjection": "Rögzített forrásvetítés",
		"atlas.sourceProjectionReady":
			"A források az elfogadott bizonyítékokból készülnek.",
		"atlas.progress.synthesize.0": "A fő mintázatok lepárlása",
		"atlas.progress.synthesize.1": "Jegyzetek alakítása felismeréssé",
		"atlas.progress.synthesize.2": "Bizonyítékok sűrítése megállapításokká",
