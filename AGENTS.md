...
- `memory.ts` owns Memory Profile overview source selection. Prefer a live Honcho overview when available, but fall back to a local durable-persona summary before showing an empty-state message.
