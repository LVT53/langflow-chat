...
- Current contradiction handling now extends beyond temporal facts: project continuity can be paused or resumed from explicit user language during turn finalization, and continuity summaries/read paths use the latest recorded project state event before trusting an older stored status.
