...
| `TITLE_GEN_SYSTEM_PROMPT` | No | empty | System prompt text for title generation | Set it in admin config or env when title generation should follow a specific prompt | If empty, title generation relies on the few-shot examples only |
